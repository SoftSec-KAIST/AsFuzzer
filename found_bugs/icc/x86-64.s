...
# Compile:      ../../bin/icc64 -c x86-64.s -o x86-64.o -diag-disable=10441
...
C2:
    ...
    loop XMMWORD PTR [1]                                  # loop 0x12
    loope XMMWORD PTR [1]                                  # loop 0x12
    loopne XMMWORD PTR [1]                                  #loop 0x12
    jecxz YMMWORD PTR [1]                              # jecxz IMM
    jrcxz QWORD PTR [1]                                # jrcxz IMM
